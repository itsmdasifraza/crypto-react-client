        ...
        <Container maxWidth="lg">
          <Grid2 container spacing={2}>
            ...
            <Grid2 xs={12} sm={3} md={3} key={76}>
              <h4>Quick links</h4>
              <Link to="/">
                <p className="link56">Home</p>
              </Link>
              <Link to="/coins">
                <p className="link56">Coins</p>
              </Link>
              <Link to="/compare">
                <p className="link56">Compare</p>
              </Link>
              <Link to="/starred">
                <p className="link56">Starred</p>
              </Link>
            </Grid2>
            <Grid2 xs={12} sm={3} md={3} key={243}>
              <h4>Top coins</h4>
              <Link to="/coin/bitcoin">
                <p className="link56">Bitcoin</p>
              </Link>
              <Link to="/coin/ethereum">
                <p className="link56">Ethereum</p>
              </Link>
              <Link to="/coin/matic-network">
                <p className="link56">Polygon</p>
              </Link>
            </Grid2>
